...
Análisando o gráfico de controle U exposto pela Figura \ref fig{fig:gcont}, percebe-se que o processo encontra dentro de controle durante todo o perído observado, de Outubro a Janeiro de 2023. Vericando os critérios de decisão em cartas de controle não foi identificado nenhum
